...
# experiment 2.
# create 2d composite verifying prediction against label overlay
...
resultsdir = os.path.join(predictiondir,'comp2d')
...
if os.path.exists(res_file):
    ...
    for t1,flair,p,l in zip(imgs[::2],imgs[1::2],preds,lbls):
        ...
        if True:
            ...
            plt.tight_layout()
            plt.savefig(os.path.join(resultsdir,'comp_' + case + '_' + str(inum) + '.png'),bbox_inches='tight',pad_inches=0.0)
            a=1
